...
export interface Category {
  ...
  /**
   * Position dans les menus, le footer et l’accueil (1 = première). Les catégories sans numéro passent en dernier.
   */
  ordre?: number | null;
  /**
   * When enabled, the slug will auto-generate from the title field on save and autosave.
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ImageTexteBlock".
 */
export interface ImageTexteBlock {
  image: number | Media;
  position?: ('left' | 'right') | null;
  largeur?: ('third' | 'half') | null;
  richText?: {
    root: {
      type: string;
      children: {
...
export interface PayloadMcpApiKey {
  ...
  livres?: {
    /**
     * Allow clients to find livres.
     */
    find?: boolean | null;
    /**
     * Allow clients to create livres.
     */
    create?: boolean | null;
    /**
     * Allow clients to update livres.
     */
    update?: boolean | null;
  };
  auteurs?: {
    /**
     * Allow clients to find auteurs.
     */
    find?: boolean | null;
    /**
     * Allow clients to create auteurs.
     */
    create?: boolean | null;
    /**
     * Allow clients to update auteurs.
     */
    update?: boolean | null;
  };
  posts?: {
  ...
  lots?: {
    /**
     * Allow clients to find lots.
     */
    find?: boolean | null;
  };
  commandesClient?: {
    /**
     * Allow clients to find commandes-client.
     */
    find?: boolean | null;
  };
  commandes?: {
    /**
     * Allow clients to find commandes.
     */
    find?: boolean | null;
  };
  updatedAt: string;
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        imageTexte?: T | ImageTexteBlockSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ImageTexteBlock_select".
 */
export interface ImageTexteBlockSelect<T extends boolean = true> {
  image?: T;
  position?: T;
  largeur?: T;
  richText?: T;
