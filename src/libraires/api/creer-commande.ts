...
import { renderCommandePdf, type LibraireInfo, type LigneCommande } from '@/libraires/BonCommandePdf'
...
// Validation d'un bon de commande libraire : recalcul serveur, fiche Payload, PDF, e-mail.
// Exposé par la route POST /api/bon-de-commande (stub dans src/app/(frontend)/api/bon-de-commande/route.ts).
